...
bool read(double **matrix, int str, int col)
{
...
void print(double **matrix,int str, int col)
{
    for (int i = 0; i < str; i++)
    {
        cout << endl;
...
void del(double ** matrix, int str)
{
    for (int i = 0; i < str; i++)
    {
        delete[] matrix[i];
...
void add(double ** &mat3, double ** mat1, double ** mat2, int str, int col)
{
    mat3 = new double *[str];
...
void sub(double ** &mat3, double ** mat1, double ** mat2, int str, int col)
{
    mat3 = new double *[str];
    for (int i = 0; i < str; i++)
    {
...
void mul(double ** mat1, double ** mat2, double ** & mat3, int str, int col, int col1)
{
    mat3 = new double *[str];
    for (int i = 0; i < str; i++)
    {
...
void T(double ** & mat3, double **matrix1, int col1, int str1)
{
...
void min_matrix(double ** mat, double **n_mat,  int i, int j, int N)
{
     int k = 0;  int  g;
...
void R(double ** & mat3, double ** matrix1, int str1, int col1, bool &print)
{
